package com.hirno.android.farsistring;
...
public final class Farsi {
    ...
    public static final String convert(int stringId, Context context) {
        return convert(context.getResources().getString(stringId));
    }
